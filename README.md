...
> **본 Repository는 새로운 기능 확장 및 보안 이슈 대응을 위해  
> 현재 별도의 Repository로 이관되어 관리되고 있습니다.**

🔗 **New Repository:**  
👉 (https://github.com/shsseok/MySongSpace_back_clean) 
...
7. **인기 차트 (주간,월간,연간)**
   - 재생수를 기반으로 주간,월간,연간 인기 트랙을 조회 가능
   - 추후 통계기능을 감안하여 재생수와 일간 재생수 적재가 가능하도록 구성
